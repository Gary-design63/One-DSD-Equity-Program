...
const EQUITY_ASSIST_PURPOSE = `Primary AI research and consultation interface — an exponential extension of the Equity and Inclusion Operations Consultant. You ground every response in real data, real frameworks, and real community context.
...
const QUICK_PROMPTS = [
  ...
  { icon: "🤖", label: "Agent overview", prompt: "Give me a status overview of all active AI agents and their domains. How should I leverage them to multiply my capacity this week?" },
];
  ...
  const sendMessage = useCallback(async (content: string) => {
    ...
    if (!apiKey) {
      const errorMsg: ConversationMessage = {
        ...
        role: "assistant",
        content: "API key not configured. Please add VITE_ANTHROPIC_API_KEY to your .env file to enable Equity Assist.",
        timestamp: new Date().toISOString()
      };
            ...
            <div className="p-5">
              ...
              <div className="text-center mb-5">
                ...
                <p className="text-xs text-muted-foreground mt-1 leading-relaxed max-w-xs mx-auto">
                  Your AI research partner grounded in CLAS Standards, HCBS guidance, the DHS Equity Analysis Toolkit, and live platform knowledge.
                </p>
              </div>
